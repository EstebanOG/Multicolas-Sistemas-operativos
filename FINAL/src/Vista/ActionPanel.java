...
public class ActionPanel extends JPanel {
	...
	public void setBtnExit(JButton btnExit) {
        ...
        public  void updatesemaforo(boolean sc) {
            
            /*ImageIcon imagen;
            if(sc){
            imagen= new ImageIcon(getClass().getResource("/imagenes/semaforoV.png"));
            }else{
            imagen= new ImageIcon(getClass().getResource("/imagenes/semaforoR.png"));
            }
            Image imgEsc = imagen.getImage().getScaledInstance(timg.getWidth(),timg.getHeight(), Image.SCALE_SMOOTH);
            Icon iconoEscalado = new ImageIcon(imgEsc);
            timg.setIcon(iconoEscalado);*/
